...
namespace JwtSecurity.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((JwtSecurity.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting ApiClientEntity instances in the database.</summary>
		public DataSource2<ApiClientEntity> ApiClient {	get { return new DataSource2<ApiClientEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
